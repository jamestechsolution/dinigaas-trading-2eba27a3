...
const FALLBACK: NavItem[] = [
  ...
  { id: "f3c", label: "Team", path: "/team", sort_order: 5, active: true },
  { id: "f3d", label: "Shareholders", path: "/shareholders", sort_order: 6, active: true },
  { id: "f4", label: "Products", path: "/products", sort_order: 7, active: true },
  { id: "f5", label: "News", path: "/news", sort_order: 8, active: true },
  { id: "f6", label: "Careers", path: "/careers", sort_order: 9, active: true },
];
